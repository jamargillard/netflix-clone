...
return(
   ...
   `}>
        ...
        <div className="flex flex-row ml-auto gap-7 items-center">
            <div className="text-gray-200 hover:text-gray-4 00 cursor-pointer transition">
            <BsSearch />
            </div>
            ...
            <div onClick={toggleAccountMenu} className="flex flex-row items-center gap-2 cursor-pointer relative">
                ...
                <BsChevronDown className={`text-white text-sm transition ${showAccountMenu ? 'rotate-180' : 'rotate-0'}`} />
